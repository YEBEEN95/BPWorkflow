sap.ui.define(
  [
    ...
    'sk/siltron/bp/BPWorkflow/controller/utils/formatter',
    'sk/siltron/bp/BPWorkflow/controller/utils/types',
    'sk/siltron/bp/BPWorkflow/controller/utils/grouper',
    'sk/siltron/bp/BPWorkflow/controller/utils/dateTime',
    'sk/siltron/bp/BPWorkflow/controller/utils/validator'
  ],
  function(
    Controller,
    History,
    ...
    return Controller.extend('sk.siltron.bp.BPWorkflow.controller.common.BaseController', {
      formatter: formatter,
      types: types,
      grouper: grouper,
      dateTime: dateTime,
